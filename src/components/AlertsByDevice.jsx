...
import { deleteAlertAction } from "../store/alerts/actions";
import {
  Table,
  TableBody,
  TableCell,
...
const AlertsByDevice = () => {
  ...
  //Alerts state
  const { alertByDevice, loading, error } = useSelector((state) => state.alerts);
